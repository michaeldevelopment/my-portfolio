...
- Usar inglés como idioma inicial y recordar la selección en el navegador para futuras visitas.
- Actualizar el atributo de idioma del documento al alternar entre inglés y español.
- Traducir navegación, portada, estadísticas, sección personal, categorías del stack, experiencia, proyectos, sitios de clientes, llamadas a la acción, etiquetas accesibles y contacto.
